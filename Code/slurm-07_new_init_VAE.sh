#!/bin/bash
#SBATCH --job-name=VAE-new-init-2type-N1000-5
#SBATCH --output=slurm-07-VAE-VAE-new-init-outputs-2type-N1000-5.txt
#SBATCH --error=slurm-07-VAE-VAE-new-init-errors-2type-N1000-5.txt
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
notebook_name=15-new-vae-initialization-2type-N1000
outname=${notebook_name}_VAE-2type-N1000-5
