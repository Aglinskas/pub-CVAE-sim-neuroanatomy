#!/bin/bash
#SBATCH --job-name=2D-N1000-5-CVAE-new-init
#SBATCH --output=slurm-01-CVAE-new-init-outputs-2D-N1000-5.txt
#SBATCH --error=slurm-01-CVAE-new-init-errors-2D-N1000-5.txt
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
notebook_name=15-new-cae-initialization_5type-new2-N1000
