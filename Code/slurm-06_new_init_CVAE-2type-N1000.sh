#!/bin/bash
#SBATCH --job-name=2type1k-5-CVAE-new-init
#SBATCH --output=slurm-01-CVAE-new-init-outputs-2type1k-5.txt
#SBATCH --error=slurm-01-CVAE-new-init-errors-2type1k-5.txt
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
notebook_name=15-new-cae-initialization_2type-N1000
