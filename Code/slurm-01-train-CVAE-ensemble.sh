#!/bin/bash
#SBATCH --job-name=N200-5-CVAE-new-init
#SBATCH --output=slurm-01-CVAE-new-init-outputs-N200-5.txt
#SBATCH --error=slurm-01-CVAE-new-init-errors-N200-5.txt
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
notebook_name=15-new-cae-initialization-N200
