#!/bin/bash
#SBATCH --job-name=5type1k-5-CVAE-new-init
#SBATCH --output=slurm-01-CVAE-new-init-outputs-5type1k-5.txt
#SBATCH --error=slurm-01-CVAE-new-init-errors-5type1k-5.txt
#SBATCH --nodes=1
#SBATCH --ntasks=1
