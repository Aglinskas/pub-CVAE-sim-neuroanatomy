#!/bin/bash
#SBATCH --job-name=2-CVAE-new-init
#SBATCH --output=slurm-01-CVAE-new-init-outputs-2.txt
#SBATCH --error=slurm-01-CVAE-new-init-errors-2.txt
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
notebook_name=15-new-cae-initialization_2type
outname=${notebook_name}-2
