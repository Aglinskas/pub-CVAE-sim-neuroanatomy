#!/bin/bash
#SBATCH --job-name=CVAE-SIM-reliability2
#SBATCH --output=slurm-01-CVAE-SIM-reliability-outputs2.txt
#SBATCH --error=slurm-01-CVAE-SIM-reliability-errors2.txt
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
echo 'running loop'
notebook_name='11-AA-train-cvae-reliability2.ipynb'
for i in {0..50}
do
    save_dir=../reliability-results/no_init_${i}_
